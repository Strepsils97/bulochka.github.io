...
/** @type {string} */
const CACHE_VERSION = '1737119751|1693822428';
/** @type {string} */
const CACHE_PREFIX = 'BEUELKA-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'BEUELKA.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["BEUELKA.html","BEUELKA.js","BEUELKA.offline.html","BEUELKA.icon.png","BEUELKA.apple-touch-icon.png","BEUELKA.worker.js","BEUELKA.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["BEUELKA.wasm","BEUELKA.pck"];
